...
<script>
     $('.submit').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('ajax/category/input')?>",
                data: form_data,
                processData: false,
                contentType: false,
                dataType: 'json',
        ...
        $('.view').on('click', function() {
            ...
            $('#modal').modal({
                ...
                $.ajax({
                    url: '<?php echo base_url('ajax/category/preview/') ?>' + id,
                    dataType: 'json',
                    success:function(data) {
                        $('#id').val(data.id);
                        $('#name').val(data.name);
        ...
        $('.edit').on('click', function() {
            var form_data   = new FormData($('#form-edit')[0]);
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('ajax/category/edit')?>",
                    data: form_data,
                    processData: false,
                    contentType: false,
                    dataType: 'json',
        ...
        $('.delete').on('click', function() {
            ...
            //console.log(id);
                $.ajax({
                    type: 'post',
                    url: '<?php echo base_url('ajax/category/delete') ?>',
